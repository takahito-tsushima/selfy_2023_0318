...
<header>
  ...
  <div class="b-example-divider"></div>
    ...
    <div class="py-5">
        ...
        <div class="text-center"><a class="btn btn-secondary rounded mx-auto" href="profile_list.php">View all / さらに見る &raquo;</a></div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body"> 
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a class="btn btn-sm btn-outline-secondary" href="view01_on.php">View</a>
        ...
        <div class="col p-4">
          ...
          <div><?= $photo_off ?></div>
            ...
            <div class="card-body"> 
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a class="btn btn-sm btn-outline-secondary" href="view03_off.php">View</a>
        ...
        <div class="col p-4">
          ...
          <div><?= $photo_old ?></div>
            ...
            <div class="card-body"> 
              <h3 class="card-text fw-bold text-center">My Hitory</h3>
              <p class="card-text fw-normal text-center">私のヒストリー</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a class="btn btn-sm btn-outline-secondary" href="view05_history.php">View</a>
        ...
        <div class="text-center pt-5"><a class="btn btn-primary rounded mx-auto" href="send.php">Send / プロフィールを送信する &raquo;</a></div>
  ...
  <div class="b-example-divider"></div>
    ...
    <div class="bg-dark text-secondary px-4 py-5 text-center">
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <a class="btn btn-outline-light px-4" href="logout_act.php">Log out</a>
      </div>
      <div class="pt-5">
